...
import { ChevronDown, Info, FileText, Mic, Square, Sparkles, Send, CheckCircle2, Trophy } from "lucide-react";
              ...
              <button
                onClick={async () => {
                  try {
                    ...
                    const content = `I scored ${feedback.score}% in the ${activeInterview.role} mock interview for ${activeInterview.company}! \u{1F3AF}`;
